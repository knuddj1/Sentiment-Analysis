...
for sub_dir in os.listdir(base_dir):
    ...
    model_path = os.path.join(sub_dir_path, 'model.json')
    weights_path = os.path.join(sub_dir_path, 'model.h5')
    ...
    results.append({sub_dir:{'test_acc': test_acc, 'test_loss': test_loss}})
    print("Completed: " + sub_dir)

with open('correct_all_results.json', 'w') as f:
    json.dump(results, f)            